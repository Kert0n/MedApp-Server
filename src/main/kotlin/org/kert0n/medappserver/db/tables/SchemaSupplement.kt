 ...
 *
 * Пользуются им двое — генератор `db/schema.sql` и тестовая оснастка. До этого те же операторы
 * стояли в оснастке своей копией, и копия успела отстать: индекс по `search_tsv` в тестовой базе
 * не создавался вовсе.
 *

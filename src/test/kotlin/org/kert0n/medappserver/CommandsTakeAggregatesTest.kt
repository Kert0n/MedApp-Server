 ...
 * заглядывает вовсе, и приватный помощник с идентификатором проезжает под разделом про агрегаты
 * незамеченным. Там правила записаны текстом, в `db/store/Access.kt`, и держатся ревью. Решения —

 ...
 * Инварианты брони.
 *
 * Инвариант всего один — количество строго положительно. Главное здесь то, чего нет:
 * **ограничения сверху**. Бронь может превышать остаток упаковки, потому что решение, чем
 * поступиться, принадлежит её владельцу, а не серверу.
 */

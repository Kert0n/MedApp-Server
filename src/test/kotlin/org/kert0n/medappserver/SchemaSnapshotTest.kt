...
class SchemaSnapshotTest {
     ...
     * Postgres. Ловит она порядок операторов: составной ключ брони ссылается на уникальность
     * `user_drugs`, и если индексы выданы общим хвостом после всех таблиц, схема не применяется
     * с нуля.
     */
    @Test
    @Transactional(propagation = Propagation.NOT_SUPPORTED)

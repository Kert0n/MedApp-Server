...
class StoreMethodRegistryTest {
    ...
    private companion object {
        ...
        val EXCLUDED = mapOf(
            ...
            "MedKitStore.insert" to "точечная вставка корня и первого membership",
            ...
            "MedKitStore.accessible" to "перепроверка членства по составному первичному ключу после блокировки",

...
/**
 * Кривой заголовок Authorization — неудачная аутентификация, а не поломка сервера.
 *
 * Такие запросы идут постоянно: сканеры, оборванные клиенты, чужие прокси. 500 на них значит,
 * что любой желающий пишет в логи стектрейсы, а мониторинг считает это отказом сервиса.
 */
@SpringBootTest
@ActiveProfiles("test")

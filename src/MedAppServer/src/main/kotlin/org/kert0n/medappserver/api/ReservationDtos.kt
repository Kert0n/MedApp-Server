 ...
 * никем не читались и лишь сообщали наружу, когда человек трогал свою аптечку.
 */
...
/**
 * Приём: сколько съедено из этой пачки.
 *
 * Различия «приём по плану» и «расход вне плана» больше нет — съеденное просто уменьшает
 * упаковку, а бронь правит её владелец отдельно.
 */

...
@Entity
@Table(
    // GIN trigram/tsvector-индексы описаны в schema.sql: JPA не выражает их opclass.
...
class VidalDrug(
     ...
     *
     * Поле read-only; [GeneratedColumn] одновременно поддерживает тестовый DDL и
     * `ddl-auto=validate` против PostgreSQL-схемы.
     */
